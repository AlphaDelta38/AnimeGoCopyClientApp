                    ...
                    <div className={cl.ListHeaderContainer}>
                        ...
                        <div className={cl.filterWatchStatusContainer}>
                            <div onClick={()=>changeChooseFilter("All")} className={cl.btn_filterStatusContainer}>
                                <div style={choseType === "All" ? {color: "black"} :{}} className={cl.filterStatus}>Все</div>
                                <span>252</span>
                            </div>
                            <div onClick={()=>changeChooseFilter("Watching")} className={cl.btn_filterStatusContainer}>
                                <div style={choseType === "Watching" ? {color: "black"} : {}}  className={cl.filterStatus}>Смотрю</div>
                                <span>252</span>
                            </div>
                            <div onClick={()=>changeChooseFilter("Watched")} className={cl.btn_filterStatusContainer}>
                                <div style={choseType === "Watched" ? {color: "black"} : {}}  className={cl.filterStatus}>Просмотрено</div>
                                <span>252</span>
                            </div>
                            <div onClick={()=>changeChooseFilter("Later")}  className={cl.btn_filterStatusContainer}>
                                <div style={choseType === "Later" ? {color: "black"} : {}}  className={cl.filterStatus}>Отложено</div>
                                <span>252</span>
                            </div>
                            <div onClick={()=>changeChooseFilter("Throw")} className={cl.btn_filterStatusContainer}>
                                <div style={choseType === "Throw" ? {color: "black"} : {}}  className={cl.filterStatus}>Брошено</div>
                                <span>252</span>
                            </div>
                            <div onClick={()=>changeChooseFilter("Planing")} className={cl.btn_filterStatusContainer}>
                                <div style={choseType === "Planing" ? {color: "black"} : {}}  className={cl.filterStatus}>Запланировано</div>
                                <span>252</span>
                            </div>
                            <div onClick={()=>changeChooseFilter("ReWatch")}  className={cl.btn_filterStatusContainer}>
                                <div style={choseType === "ReWatch" ? {color: "black"} : {}} className={cl.filterStatus}>Пересматриваю</div>
                                <span>252</span>
                            </div>
                        </div>
                    </div>
